...
select k.id_khach_hang,k.ho_ten,
        ...
        sum(dv.chi_phi_thue+(ht.so_luong*dk.gia)) as tong_tien
from khach_hang k
left join loai_khach lk on lk.id_loai_khach=k.id_loai_khach
left join hop_dong hd on hd.id_khach_hang=k.id_khach_hang
