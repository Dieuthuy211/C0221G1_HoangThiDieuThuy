...
select *
from nhan_vien
where ho_ten like "k%" or ho_ten like "H%" or ho_ten like"T%" and char_length(ho_ten)<16;

-- 3.	Hiển thị thông tin của tất cả khách hàng có độ tuổi từ 18 đến 50 tuổi và có địa chỉ ở “Đà Nẵng” hoặc “Quảng Trị”.
select *
from khach_hang
where  ((2021-year(ngay_sinh))>18 and (2021-year(ngay_sinh))<50) and (dia_chi="da nang" or dia_chi="quang tri" );
...
dv.ten_dich_vu,
sum(dv.chi_phi_thue+dk.don_vi*dk.gia) as tong_tien
from  hop_dong hd
