...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
    ...
    <div class="collapse navbar-collapse ml-5" id="navbarScroll">
        ...
        <form class="d-flex m-2" action="/employees?action=search" method="post">
    ...
    <div class="container-fluid border pt-5 mt-5">
        ...
        <div class="row" style="margin-left: 5px">
            <div ><a class="btn btn-default-btn-xs btn-success"
                     href="/employees?action=create">New create</a>
            </div>
        </div>
        <table id="tableEmployee" class="container table table-bordered table-striped ">
            ...
            <c:forEach items="${employees}" var="employee" varStatus="counts">
                <tr>
                    <td>${counts.count}</td>
                    <td><a href="/employees?action=view&id=${employee.id}">${employee.id}</a>
                    </td>
                    <td>${employee.name}</td>
